		...
		<div class="container">
			<div
				...
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="/departmental/">Home</a></span> <span>Update Product</span>
					</p>
						...
						<div class="row align-items-end">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<form:input path="productId" value="${product.productId }" readOnly="readOnly" type="text" required="true"
